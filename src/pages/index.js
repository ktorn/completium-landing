  ...
  return (
    <Grid container direction='column' justify="center" alignItems="center" style={{
      ...
      <Grid item style={{textAlign: 'center', marginTop: '100px'}}>
        <Typography>We help you create <span style={{ fontWeight: 'bold'}}>Dapps</span> from off-chain application (front&back-ends)<br/> to verified smart contracts</Typography>
      </Grid>
    </Grid>
  )
}
      ...
      <Grid item xs={12} style={{ textAlign: 'center' }}>
        <Grid container direction='row' justify="center" alignItems="center" style={{ width: '100%' }}>
          ...
          <Grid item xs={2} style={{ textAlign: 'center' }}>
            <Feature name='undraw_setup_wizard' title='Step by Step Tutorials' text='Follow step by step instructions to implement, deploy and interact with smart contracts, connect the Dapp to wallet, ...'/>
          </Grid>
          <Grid item xs={1}></Grid>
        </Grid>
      </Grid>
...
function Service() {
  return (
    <Grid container direction='column' justify="center" alignItems="center" style={{ padding: '50px' }}>
      <Grid item xs={12} style={{ textAlign: 'center' }}>
        <Typography variant='h4' style={{ fontWeight: 'bold' }}>
          Nice to meet you! <EmojiEmotionsIcon />
        </Typography>
      </Grid>
    </Grid>
  )
